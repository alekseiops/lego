...
To get the binary just download the latest release for your OS/Arch from [the release page](https://github.com/alekseiops/lego/releases) and put the binary somewhere convenient.
...
```bash
go install github.com/alekseiops/lego/v4/cmd/lego@latest
```
